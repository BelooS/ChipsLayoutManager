...
You can manipulate with layout direction (**LTR** or **RTL**)
_On Api >= 17:_
```XML
...
### Contributors
BETA is going. I respond to your founded issues. Just create a ticket if you found something goes wrong. <br/><br/>
